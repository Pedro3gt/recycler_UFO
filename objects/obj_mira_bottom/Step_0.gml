...
if (objeto_colicionado !=noone and keyboard_check_pressed(vk_down)){
	global.puntos+=10;
...
if (objeto_derecha !=noone and keyboard_check_pressed(vk_down)){
	global.puntos+=10;
		with (objeto_derecha){
				global.basura-=1;
...
if (objeto_bidon1 !=noone and keyboard_check_pressed(vk_down)){
...
if (objeto_bidon2 !=noone and keyboard_check_pressed(vk_down)){
	if (global.gasolina-2<=0){
		global.gasolina=0;
	}
	else{
...
if (objeto_astronauta1 !=noone and keyboard_check_pressed(vk_down)){
...
if (objeto_astronauta2 !=noone and keyboard_check_pressed(vk_down)){
	if (global.gasolina+2>=10){
		global.gasolina=10;
	}
	else{
